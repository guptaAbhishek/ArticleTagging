...
def main():
    ...
    sentence = "Sanjay Pathak, inspector of Shahpur police station, told HT on the phone that a local resident identified as Subhash complained that some people shouted slogans in favour of Pakistan and burst crackers after Pakistan handed India a shock 180-run defeat in the finals on Sunday."
    t = [sentence.split(" ")]
    print t
    bigram = Phrases(t, min_count=1, threshold=2)
    sent = [u'Sanjay', u'Pathak,', u'inspector', u'of', u'Shahpur', u'police', u'station,', u'told', u'HT', u'on', u'the', u'phone', u'that', u'a', u'local', u'resident', u'identified', u'as', u'Subhash', u'complained', u'that', u'some', u'people', u'shouted', u'slogans', u'in', u'favour', u'of', u'Pakistan', u'and', u'burst', u'crackers', u'after', u'Pakistan', u'handed', u'India', u'a', u'shock', u'180-run', u'defeat', u'in', u'the', u'finals', u'on', u'Sunday.']
    print bigram[sent]
